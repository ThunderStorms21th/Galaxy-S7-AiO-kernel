...
echo "" > builds/ramdisk/ramdisk/carrier/.placeholder
...
echo "" > builds/ramdisk/ramdisk/dqmdbg/.placeholder
echo "" > builds/ramdisk/ramdisk/efs/.placeholder
echo "" > builds/ramdisk/ramdisk/keydata/.placeholder
echo "" > builds/ramdisk/ramdisk/keyrefuge/.placeholder
echo "" > builds/ramdisk/ramdisk/lib/modules/.placeholder
echo "" > builds/ramdisk/ramdisk/mnt/.placeholder
echo "" > builds/ramdisk/ramdisk/odm/.placeholder
echo "" > builds/ramdisk/ramdisk/oem/.placeholder
echo "" > builds/ramdisk/ramdisk/omr/.placeholder
...
echo "" > builds/ramdisk/ramdisk/vendor/.placeholder
