...
struct request_queue {
	...
	request_fn_proc		*request_fn;
    	request_fn_proc		*urgent_request_fn; // ROW
	...
	struct queue_limits	limits;
    	bool			notified_urgent;	// ROW
	bool			dispatched_urgent;	// ROW
...
extern int blk_reinsert_request(struct request_queue *q, struct request *rq);	// ROW
extern bool blk_reinsert_req_sup(struct request_queue *q);			// ROW
...
extern void blk_urgent_request(struct request_queue *q, request_fn_proc *fn);	// ROW
