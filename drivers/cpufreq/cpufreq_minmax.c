...
static inline unsigned int get_cpu_idle_time1(unsigned int cpu)
{
...
j_dbs_info->prev_cpu_idle_up = get_cpu_idle_time1(j);
...
/* Check for frequency increase */
total_idle_ticks = get_cpu_idle_time1(cpu);
...
j_dbs_info->prev_cpu_idle_up = get_cpu_idle_time1(cpu);
