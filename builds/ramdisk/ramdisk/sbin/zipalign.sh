...
# Needed for log
if [ ! -d /data/.tskernel ]; then
mkdir -p /data/.tskernel
fi
# Begin
chown 0:0 /data/.tskernel/zipalign.log
chmod 755 /data/.tskernel/zipalign.log

LOG_FILE=/data/.tskernel/zipalign.log
ZIPALIGNDB=/data/.tskernel/zipalign.db
